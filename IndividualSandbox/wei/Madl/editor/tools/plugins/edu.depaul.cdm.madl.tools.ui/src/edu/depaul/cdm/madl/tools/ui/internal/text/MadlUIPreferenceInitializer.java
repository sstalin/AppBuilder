...
public class MadlUIPreferenceInitializer extends AbstractPreferenceInitializer {
  ...
  public void initializeDefaultPreferences() {
    ...
    IEclipsePreferences defaultPreferences = new DefaultScope().getNode(MadlCore.PLUGIN_ID);
