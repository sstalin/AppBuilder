 ...
 */
public class MadlPartitionScanner extends RuleBasedPartitionScanner implements MadlPartitions {
  ...
  public MadlPartitionScanner() {
    ...
    IToken string = new Token(MADL_STRING);
    @SuppressWarnings("deprecation")
    IToken character = new Token(JAVA_CHARACTER);
    IToken javaDoc = new Token(MADL_DOC);
    IToken multiLineComment = new Token(MADL_MULTI_LINE_COMMENT);
    IToken singleLineComment = new Token(MADL_SINGLE_LINE_COMMENT);
    IToken singleLineDoc = new Token(MADL_SINGLE_LINE_DOC);
