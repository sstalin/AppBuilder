 ...
 *
 */
public final class SingleTokenMadlScanner extends AbstractMadlScanner {

  private final String[] fProperty;

  public SingleTokenMadlScanner(IColorManager manager, IPreferenceStore store, String property) {
    super(manager, store);
