 ...
 * the License.
 */
package edu.depaul.cdm.madl.tools.ui.internal.text.functions;
 ...
 */
public class FastMadlPartitionScanner implements IPartitionTokenScanner, MadlPartitions {
  /**
   ...
   * {@link FastMadlPartitionScanner#nextToken()}.
   */
  ...
  private static IToken SINGLE_LINE_COMMENT_TOKEN = new Token(MADL_SINGLE_LINE_COMMENT);
  private static IToken SINGLE_LINE_DOC_COMMENT_TOKEN = new Token(MADL_SINGLE_LINE_DOC);
  private static IToken MULTI_LINE_COMMENT_TOKEN = new Token(MADL_MULTI_LINE_COMMENT);
  private static IToken DOC_COMMENT_TOKEN = new Token(MADL_DOC);
  private static IToken STRING_TOKEN = new Token(MADL_STRING);
  private static IToken MULTI_LINE_STRING_TOKEN = new Token(MADL_MULTI_LINE_STRING);
...
//    } else if (contentType.equals(MADL_SINGLE_LINE_COMMENT)) {
//      return ScannerState.SINGLE_LINE_COMMENT;
//    } else if (contentType.equals(MADL_MULTI_LINE_COMMENT)) {
//      return ScannerState.MULTI_LINE_COMMENT;
//    } else if (contentType.equals(MADL_DOC)) {
//      return ScannerState.DOC_COMMENT;
//    } else if (contentType.equals(MADL_STRING)) {
//      return ScannerState.STRING;
//    } else if (contentType.equals(MADL_MULTI_LINE_STRING)) {
...
//  }
   ...
   */
  public FastMadlPartitionScanner() {
    super();
  }
  ...
  public void setPartialRange(IDocument document, int offset, int length, String contentType,
    ...
    if (contentType != null && contentType.equals(MADL_MULTI_LINE_STRING)) {
