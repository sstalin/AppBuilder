...
public class MadlCompletionProposal implements ICompletionProposal,
	...
	public void apply(ITextViewer viewer, char trigger, int stateMask,
		...
		String modifiedDocText = lineText.substring(0, offsetInLine
				- offsetDiff)
				+ proposal + lineText.substring(offsetInLine);
	...
	private int calcualteOffsetDifference(int offsetInLine, IDocument doc,
			String lineText) {
		if (lineText == null)
			lineText = doc.get();
