...
/**
 * The interface <code>MadlElementDelta</code> describes changes in Madl elements between two
 ...
 * closed. This flag is only valid if the element is an {@link MadlProject}.</li>
 ...
 * opened. This flag is only valid if the element is an {@link MadlProject}.</li>
 ...
 * </p>
 * <p>
 * {@link MadlElementDelta} object are not valid outside the dynamic scope of the notification.
 * </p>
 * 
 * @coverage madl.tools.core.model
 */
public interface MadlElementDelta {
  /**
   ...
   * opened. This flag is only valid if the element is a {@link MadlProject}.
   */
  public int F_OPENED = 0x000200;

  /**
   * Change flag indicating that the underlying {@link org.eclipse.core.resources.IProject} has been
   * closed. This flag is only valid if the element is a {@link MadlProject}.
   */
   ...
   * valid if the element is a {@link MadlLibrary}.
   */
   ...
   * @return deltas for the children that have been added
   */
  public MadlElementDelta[] getAddedChildren();
   ...
   * @return deltas for the affected (added, removed, or changed) children
   */
  public MadlElementDelta[] getAffectedChildren();
   ...
   * @return deltas for the children which have changed
   */
  public MadlElementDelta[] getChangedChildren();
...
//  public CompilationUnit getCompilationUnitAST();
   ...
   */
  public MadlElement getMovedFromElement();
   ...
   *         flag is not set
   */
  public MadlElement getMovedToElement();
   ...
   * @return deltas for the children which have been removed
   */
  public MadlElementDelta[] getRemovedChildren();
