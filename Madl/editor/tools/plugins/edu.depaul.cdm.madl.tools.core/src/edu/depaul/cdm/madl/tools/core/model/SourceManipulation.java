...
/**
 * The interface <code>SourceManipulation</code> defines behavior common to Madl elements that
...
public interface SourceManipulation {
   ...
   * @throws MadlModelException if this element could not be copied. Reasons include:
   *           <ul>
   *           <li>This Madl element, container element, or sibling does not exist
   ...
   */
  public void copy(MadlElement container, MadlElement sibling, String rename, boolean replace,
   ...
   * @param monitor a progress monitor
   * @throws MadlModelException if this element could not be deleted. Reasons include:
   *           <ul>
   ...
   *          name collision
   * @param monitor a progress monitor
   * @throws MadlModelException if this element could not be moved. Reasons include:
   *           <ul>
   *           <li>This Madl element, container element, or sibling does not exist
   *           (ELEMENT_DOES_NOT_EXIST)</li>
   *           <li>A <code>CoreException</code> occurred while updating an underlying resource
   ...
   * @throws IllegalArgumentException if container is <code>null</code>
   */
  public void move(MadlElement container, MadlElement sibling, String rename, boolean replace,
      IProgressMonitor monitor) throws MadlModelException;
   ...
   *          collision
   * @param monitor a progress monitor
   * @throws MadlModelException if this element could not be renamed. Reasons include:
   *           <ul>
   *           <li>This Madl element does not exist (ELEMENT_DOES_NOT_EXIST)</li>
   *           <li>A <code>CoreException</code> occurred while updating an underlying resource
   *           <li>The new name is invalid (INVALID_NAME)
