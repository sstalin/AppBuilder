...
public interface CompilationUnit extends CodeAssistElement, SourceFileElement<CompilationUnit>,
  ...
  /**
   * Return the Madl elements corresponding to the given selected text in this compilation unit. The
   ...
   *          units
   * @return the Madl elements corresponding to the given selected text
   * @throws MadlModelException if code resolve could not be performed. Reasons include:
   *           <ul>
   *           <li>This Madl element does not exist (ELEMENT_DOES_NOT_EXIST) </li> <li> The range
   *           specified is not within this element's source range (INDEX_OUT_OF_BOUNDS)
   *           </ul>
   */
	//ss
/*  public MadlElement[] codeSelect(MadlUnit ast, int offset, int length, WorkingCopyOwner owner)
   ...
   * @throws MadlModelException if the element could not be created. Reasons include:
   *           <ul>
   ...
   *           </ul>
   */
  public Type createType(String contents, MadlElement sibling, boolean force,
   ...
   * @throws MadlModelException if the class type aliases defined in this compilation unit cannot be
   *           determined
   */
 // public MadlClassTypeAlias[] getClassTypeAliases() throws MadlModelException;
   ...
   * @throws MadlModelException if the contents of the compilation unit cannot be accessed
   */
  public MadlElement getElementAt(int offset) throws MadlModelException;
   ...
   * @throws MadlModelException if the function type aliases defined in this compilation unit cannot
   *           be determined
   */
 // public MadlFunctionTypeAlias[] getFunctionTypeAliases() throws MadlModelException;
   ...
   * @throws MadlModelException if the global variables defined in this compilation unit cannot be
   *           determined
   */
 ...
 // public MadlLibrary getLibrary();
   ...
   * @see MadlConventions#validateTypeName(String name)
   */
   ...
   * @throws MadlModelException if the types defined in this compilation unit cannot be determined
   */
