 ...
 * the License.
 */
package edu.depaul.cdm.madl.tools.core.problem;

//import edu.depaul.cdm.madl.compiler.ErrorCode;
//import edu.depaul.cdm.madl.tools.core.internal.problem.ProblemSeverities;

/**
 * The interface <code>Problem</code> defines the behavior of objects that represent a Madl problem,
 ...
 * </ul>
 * Note: the compiler produces Problems internally, which are turned into markers by the MadlBuilder
 * so as to persist problem descriptions. This explains why there is no API allowing to reach
 * Problem detected when compiling. However, the Madl problem markers carry equivalent information
 * to Problem, in particular their ID (attribute "id") is set to one of the IDs defined on this
 * interface.
 * 
 * @coverage madl.tools.core.problem
 */
