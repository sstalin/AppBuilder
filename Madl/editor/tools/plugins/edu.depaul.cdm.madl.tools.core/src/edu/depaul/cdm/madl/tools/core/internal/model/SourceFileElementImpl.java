...
//import edu.depaul.cdm.madl.compiler.util.MadlSourceString;
...
import edu.depaul.cdm.madl.tools.core.internal.buffer.DocumentAdapter;
...
import edu.depaul.cdm.madl.tools.core.model.SourceFileElement;
...
public abstract class SourceFileElementImpl<E> extends OpenableElementImpl implements
  ...
  public SourceFileElementImpl(CompilationUnitContainer container, IFile file,
    ...
    super((MadlElementImpl) container);
    this.file = file;
    this.owner = owner;
  }
  ...
  public UndoEdit applyTextEdit(TextEdit edit, IProgressMonitor monitor) throws MadlModelException {
    ...
    if (buffer instanceof Buffer.TextEditCapability) {
      ...
      try {
        ...
        throw new MadlModelException(e, MadlModelStatusConstants.BAD_TEXT_EDIT_LOCATION);
  ...
  /**
   * Returns the primary Madl source file element (whose owner is the primary owner) this working
   * copy was created from, or this Madl source file element if this a primary Madl file.
   * <p>
   * Note that the returned primary Madl source file element can be in working copy mode.
   * 
   * @return the primary Madl source file element this working copy was created from, or this Madl
  ...
  public MadlSource getSourceRef() throws MadlModelException {
    return new MadlSourceString(getElementName(), getSource());
  }
  ...
  public boolean isReadOnly() {
    return file.isReadOnly() || MadlCore.isPackagesResource(file);
  }
   ...
   * @throws MadlModelException if this source file element could not become a working copy
   ...
   * @throws MadlModelException if the file does not exist
   */
  protected void readBuffer(Buffer buffer, boolean isWorkingCopy) throws MadlModelException {
