...
public interface Type extends CompilationUnitElement, ParentElement, SourceManipulation,
   ...
   * <li> <code>false</code> - in this case a <code>MadlModelException</code> is thrown</li>
   * </ul>
   * 
   ...
   *           <ul>
   *           <li>This Madl element does not exist (ELEMENT_DOES_NOT_EXIST) </li> <li>A <code>
...
/*  public Method[] findMethods(Method method);*/
 ...
 // public Method getMethod(String name, String[] parameterTypeSignatures);
  ...
  /**
   * @return the {@link MadlTypeParameter}s declared by this type
   */
 // public MadlTypeParameter[] getTypeParameters() throws MadlModelException;
   ...
   * @deprecated Madl does not have a notion of qualified type names - this method should be removed
   */
  @Deprecated
