...
/**
 * The interface <code>CodeAssistElement</code> defines the behavior common to Madl elements that
...
public interface CodeAssistElement {
   ...
   * @throws MadlModelException if code assist could not be performed. Reasons include:
   *           <ul>
   ...
   * @throws MadlModelException if code assist could not be performed. Reasons include:
   *           <ul>
   *           <li>This Madl element does not exist (ELEMENT_DOES_NOT_EXIST) </li> <li> The position
   ...
   *           </ul>
   */
  public MadlElement[] codeSelect(int offset, int length, WorkingCopyOwner owner)
      throws MadlModelException;
}
