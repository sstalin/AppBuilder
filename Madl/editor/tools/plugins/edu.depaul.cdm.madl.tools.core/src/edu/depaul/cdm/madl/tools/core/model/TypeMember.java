...
public interface TypeMember extends CompilationUnitElement, ParentElement, SourceManipulation,
   ...
   * @return the modifiers that were explicitly declared for this element
   */
 // public MadlModifiers getModifiers();
   ...
   * @throws MadlModelException if the list of overridden members could not be computed
   */
  public TypeMember[] getOverriddenMembers() throws MadlModelException;
