...
/**
 * The interface <code>OpenableElement</code> defines behavior common to Madl elements that must be
 ...
 * <p>
 * To reduce complexity in clients, elements are automatically opened by the Madl model as element
 * properties are accessed. The Madl model maintains an LRU cache of open elements, and
 ...
 * <p>
 * To open an element, all openable parent elements must be open. The Madl model automatically opens
 ...
 */
public interface OpenableElement extends MadlElement {
  /**
   ...
   * elements - the Madl model does this automatically as elements are accessed.
   * 
   * @throws MadlModelException if an error occurs while closing this element
   */
   ...
   */
  public boolean isConsistent() throws MadlModelException;
   ...
   * @throws MadlModelException if the element is unable to access the contents of its underlying
   *           resource. Reasons include:
   *           <ul>
   *           <li>This Madl element does not exist (ELEMENT_DOES_NOT_EXIST) </li>
   *           </ul>
   * @see IOpenable#isConsistent()
   * @see ICompilationUnit#reconcile(int, boolean, WorkingCopyOwner, IProgressMonitor)
   */
  public void makeConsistent(IProgressMonitor progress) throws MadlModelException;
   ...
   * 
   * @param progress the given progress monitor
   * @throws MadlModelException if an error occurs accessing the contents of its underlying
   *           resource. Reasons include:
   *           <ul>
   *           <li>This Madl element does not exist (ELEMENT_DOES_NOT_EXIST) </li>
   *           </ul>
   */
  public void open(IProgressMonitor progress) throws MadlModelException;
   ...
   *           resource. Reasons include:
   *           <ul>
   *           <li>This Madl element does not exist (ELEMENT_DOES_NOT_EXIST) </li> <li>This Madl
   *           element is read-only (READ_ONLY)</li>
   *           </ul>
   */
  public void save(IProgressMonitor progress, boolean force) throws MadlModelException;
}
