 ...
 * the License.
 */
package edu.depaul.cdm.madl.tools.core.completion;
 ...
 * completion occurs.
 * 
 * @coverage madl.tools.core.completion
 */
public class CompletionContext {
  ...
  /**
   * Return the innermost enclosing Madl element which contains the completion location or
   * <code>null</code> if this element cannot be computed. The returned Madl element and all Madl
   * elements in the same compilation unit which can be navigated to from the returned Madl element
   * are special Madl elements:
   * <ul>
   ...
   */
  public MadlElement getEnclosingElement() {
  ...
  /**
   * Return the completed token. This token is either the identifier or Madl language keyword or the
   ...
   * the relevant token being completed. This token is either the identifier or Madl language
   ...
   * </ul>
   * Returned elements defined in the completed compilation unit are special Madl elements:
   * <ul>
   * <li>they are based on the current content of the compilation unit's buffer, they are not the
   * result of a reconcile operation</li>
   * <li>they are not updated if the buffer changes.</li>
   ...
   * @see #isExtended()
   */
  public MadlElement[] getVisibleElements(String typeSignature) {
    return null; // default overridden by concrete implementation
  }
