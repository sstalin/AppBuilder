...
/**
 * The interface <code>MadlModel</code> defines the behavior of the root Madl element corresponding
 * to the workspace.
 * 
 * @coverage madl.tools.core.model
 */
public interface MadlModel extends MadlElement {
   ...
   * @throws MadlModelException if an element could not be copied. Reasons include:
   *           <ul>
   ...
   *           </ul>
   */
  public void copy(MadlElement[] elements, MadlElement[] containers, MadlElement[] siblings,
      String[] renamings, boolean replace, IProgressMonitor monitor) throws MadlModelException;
   ...
   * @param monitor a progress monitor
   * @throws MadlModelException if an element could not be deleted. Reasons include:
   *           <ul>
   *           <li>There is no element to process ( <code>NO_ELEMENTS_TO_PROCESS</code>) because the
   *           given elements is <code>null</code> or empty</li>
   ...
   *           </ul>
   */
  public void delete(MadlElement[] elements, boolean force, IProgressMonitor monitor)
   ...
   * 
   * @return an array containing the bundled libraries
   * @throws MadlModelException if the bundled libraries could not be accessed for some reason
   */
  //public MadlLibrary[] getBundledLibraries() throws MadlModelException;

  /**
   * Return the bundled core library.
   * 
   * @return the bundled core library
   * @throws MadlModelException if the core library could not be accessed for some reason
   */
  //public MadlLibrary getCoreLibrary() throws MadlModelException;

  /**
   * Return the Madl project containing or corresponding to the given resource.
   * 
   * @param resource the resource whose project is to be returned
   * @return the Madl project containing or corresponding to the given resource
   */
 // public MadlProject getMadlProject(IResource resource);

  /**
   * Return the Madl project with the given name.
   * 
   * @param projectName the name of the project to be returned
   * @return the Madl project with the given name
   */
  //public MadlProject getMadlProject(String projectName);

  /**
   * Return an array containing all of the Madl projects currently defined in the workspace.
   * 
   * @return all of the Madl projects currently defined in the workspace
   * @throws MadlModelException if the contents of the model cannot be accessed
   */
 // public MadlProject[] getMadlProjects() throws MadlModelException;

  /**
   * Return an array of non-Madl resources (that is, non-Madl projects) in the workspace.
   * <p>
   * Non-Madl projects include all projects that are closed (even if they have the Madl nature).
   * 
   * @return an array of non-Madl projects (<code>IProject</code>s) contained in the workspace
   ...
   * @throws MadlModelException if the list of libraries cannot be determined
   */
 // public List<MadlLibrary> getUnreferencedLibraries() throws MadlModelException;
   ...
   *          a name collision
   * @param monitor a progress monitor
   * @exception MadlModelException if an element could not be moved. Reasons include:
   *              <ul>
   ...
   */
  public void move(MadlElement[] elements, MadlElement[] containers, MadlElement[] siblings,
      String[] renamings, boolean replace, IProgressMonitor monitor) throws MadlModelException;
   ...
   *          a name collision
   * @param monitor a progress monitor
   * @throws MadlModelException if an element could not be renamed. Reasons include:
   *           <ul>
   *           <li>There is no element to process ( <code>NO_ELEMENTS_TO_PROCESS</code>) because the
   ...
   *           </ul>
   */
  public void rename(MadlElement[] elements, MadlElement[] destinations, String[] names,
      boolean replace, IProgressMonitor monitor) throws MadlModelException;
}
