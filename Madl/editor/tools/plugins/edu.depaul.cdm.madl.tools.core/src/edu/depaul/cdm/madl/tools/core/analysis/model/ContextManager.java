...
public interface ContextManager {
  ...
  /**
   * Answer the {@link MadlSdk} associated with this manager.
   * 
   ...
   * MadlCore.ENABLE_HINTS_MADL2JS_PREFERENCE
   * 
   * @param enableMadl2JSHints
   */
  void setMadl2JSHintOption(boolean enableMadl2JSHints);

  /**
   * Set the hint option for all the analysis context, based on changes to the hint preference
   * MadlCore.ENABLE_HINT_PREFERENCE
   * 
   * @param enableHint
   */
