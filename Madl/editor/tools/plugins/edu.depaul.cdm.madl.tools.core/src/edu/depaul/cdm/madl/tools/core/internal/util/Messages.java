...
public final class Messages extends NLS {
  private static final String BUNDLE_NAME = "edu.depaul.cdm.madl.tools.core.internal.util.messages";//$NON-NLS-1$
  ...
  public static String convention_unitName_notMadlName;
