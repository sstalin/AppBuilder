 ...
 * the License.
 */
package edu.depaul.cdm.madl.tools.core.buffer;
 ...
 * <p>
 * Note that Madl model operations that manipulate a <code>Buffer</code> (for example,
 ...
 * </p>
 * 
 * @coverage madl.tools.core.buffer
 */
public interface Buffer {
  ...
  public interface TextEditCapability {
     ...
     * @throws MadlModelException if this edit cannot be applied to the buffer. Reasons include:
     *           <ul>
     *           <li>The provided edit can not be applied as there is a problem with the text edit
     *           locations ( {@link MadlModelStatusConstants#BAD_TEXT_EDIT_LOCATION})}.</li>
     *           </ul>
     */
  ...
  /**
   * Returns the Madl element owning of this buffer.
   * 
   * @return the Madl element owning this buffer
   */
   ...
   *          inconsistencies.
   * @throws MadlModelException if an error occurs writing the buffer to the underlying resource
