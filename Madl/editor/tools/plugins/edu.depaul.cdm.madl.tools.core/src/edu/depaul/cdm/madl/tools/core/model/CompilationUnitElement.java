 ...
 * {@link MadlElement Madl elements} that are contained, either directly or indirectly, in a
 * {@link CompilationUnit compilation unit}.
 * 
 * @coverage madl.tools.core.model
 */
public interface CompilationUnitElement extends MadlElement, MadlDocumentable {
  /**
