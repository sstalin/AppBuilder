 ...
 * the License.
 */
package edu.depaul.cdm.madl.tools.core.workingcopy;
...
import edu.depaul.cdm.madl.tools.core.model.MadlElementDelta;
...
public abstract class WorkingCopyOwner {
   ...
   * <p>
   * </p>
   * Options used to create the DOM AST are got from {@link MadlCore#getOptions()} as it is not
   * possible to set the options on a non-existing Madl project. </p>
   * <p>
   * When the working copy instance is created, an {@link MadlElementDelta#ADDED added delta} is
   ...
   * </p>
   * 
   * @param name the name of the working copy (e.g. "X.madl")
   ...
   * @throws MadlModelException if the contents of this working copy can not be determined
   */
