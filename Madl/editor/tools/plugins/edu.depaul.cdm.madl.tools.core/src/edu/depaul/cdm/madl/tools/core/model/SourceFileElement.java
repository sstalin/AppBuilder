...
//import edu.depaul.cdm.madl.compiler.MadlSource;
 ...
 * containing editable Madl source code.
 * 
...
public interface SourceFileElement<E> extends OpenableElement, SourceReference {
   ...
   * @throws MadlModelException if this edit can not be applied to the element's buffer. Reasons
   *           include:
   *           <ul>
   *           <li>This element does not exist (
   *           {@link MadlModelStatusConstants#ELEMENT_DOES_NOT_EXIST}).</li> <li>The provided edit
   *           can not be applied as there is a problem with the text edit locations (
   *           {@link MadlModelStatusConstants#BAD_TEXT_EDIT_LOCATION}).</li>
   *           </ul>
   */
  public UndoEdit applyTextEdit(TextEdit edit, IProgressMonitor monitor) throws MadlModelException;
   ...
   * @throws MadlModelException if this element could not become a working copy
   * @see #discardWorkingCopy()
   */
  public void becomeWorkingCopy(IProgressMonitor monitor) throws MadlModelException;
   ...
   * resource</li>
   * <li> <code>false</code> - in this case a {@link MadlModelException} is thrown</li>
   * </ul>
   * <p>
   ...
   * @throws MadlModelException if this working copy could not commit. Reasons include:
   *           <ul>
   ...
   * </p>
   * 
   * @throws MadlModelException if this working copy could not return in its original mode.
  ...
  /**
   * Returns the primary Madl element (whose owner is the primary owner) this working copy was
   * created from, or this Madl element if this a primary Madl file.
   * <p>
   * Note that the returned primary Madl element can be in working copy mode.
   * 
   * @return the primary Madl element this working copy was created from, or this Madl element if it
   *         is primary
   */
  public E getPrimary();
   ...
   */
  //public MadlSource getSourceRef() throws MadlModelException;
   ...
   * instead.
   * <p>
   * When the working copy instance is created, an ADDED MadlElementDelta is reported on this
   * working copy.
   * <p>
   ...
   * @throws MadlModelException if the contents of this element can not be determined
   */
  public E getWorkingCopy(IProgressMonitor monitor) throws MadlModelException;
   ...
   * <p>
   * When the shared working copy instance is created, an ADDED MadlElementDelta is reported on this
   * working copy.
   * <p>
   * A working copy can be created on a not-yet existing element. In particular, such a working copy
   * can then be committed in order to create the corresponding element.
   ...
   * 
   * @throws MadlModelException if the contents of the original element cannot be accessed. Reasons
   *           include:
   *           <ul>
   *           <li> The original Madl element does not exist (ELEMENT_DOES_NOT_EXIST)</li>
   *           </ul>
   */
