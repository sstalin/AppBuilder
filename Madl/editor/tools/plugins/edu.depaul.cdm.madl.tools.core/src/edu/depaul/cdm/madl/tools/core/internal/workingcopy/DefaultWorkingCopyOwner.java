 ...
 * the License.
 */
package edu.depaul.cdm.madl.tools.core.internal.workingcopy;
...
public class DefaultWorkingCopyOwner extends WorkingCopyOwner {
  ...
  private static final String EXTENSION_POINT_ID = MadlCore.PLUGIN_ID + ".workingCopyOwner";
  ...
  private void initialize() {
    ...
    if (elements.length > 0) {
      if (elements.length > 1) {
        MadlCore.logError("Error, more then one working copy owner replacement contributed", null);
      }
