 ...
 */
public class MadlDocAutoIndentStrategy extends DefaultIndentLineAutoEditStrategy {
  private String partitioning;

  public MadlDocAutoIndentStrategy(String partitioning) {
