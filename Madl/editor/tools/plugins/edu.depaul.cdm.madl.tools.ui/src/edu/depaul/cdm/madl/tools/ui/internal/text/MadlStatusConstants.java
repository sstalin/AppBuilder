 ...
 * the License.
 */
package edu.depaul.cdm.madl.tools.ui.internal.text;

/**
 * Defines status codes relevant to the Madl UI plug-in. When a Core exception is thrown, it contain
 * a status object describing the cause of the exception. The status objects originating from the
 * Madl UI plug-in use the codes defined in this interface.
 */
public interface MadlStatusConstants {

  // Madl UI status constants start at 10000 to make sure that we don't
