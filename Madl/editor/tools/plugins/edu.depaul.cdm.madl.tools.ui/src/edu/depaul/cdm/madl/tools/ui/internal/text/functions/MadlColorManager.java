...
public class MadlColorManager implements IColorManager, IColorManagerExtension {
	   ...
	   */
	  public MadlColorManager(boolean autoDisposeOnDisplayDispose) {
