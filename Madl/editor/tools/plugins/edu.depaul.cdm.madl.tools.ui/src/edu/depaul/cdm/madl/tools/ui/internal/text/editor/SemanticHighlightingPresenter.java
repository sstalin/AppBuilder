...
//						continue;
  ...
  public TextPresentation createPresentation(List<Position> addedPositions,
    ...
    MadlSourceViewer sourceViewer = fSourceViewer;
    MadlPresentationReconciler presentationReconciler = fPresentationReconciler;
   ...
   *          called
   */
  public void install(MadlSourceViewer sourceViewer,
      MadlPresentationReconciler backgroundPresentationReconciler) {
