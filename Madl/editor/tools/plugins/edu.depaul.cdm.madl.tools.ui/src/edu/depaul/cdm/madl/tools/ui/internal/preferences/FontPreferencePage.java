...
import edu.depaul.cdm.madl.tools.ui.internal.text.editor.MadlDocumentSetupParticipant;
  ...
  private static class FontSelectionComposite extends Composite {
    ...
    public FontSelectionComposite(Composite parent, int style, String baseKey, String key,
      ...
      // font scaling
      {
        ...
        smallFontsButton.setText(PreferencesMessages.MadlBasePreferencePage_font_scale_indicator);
        ...
        mediumFontsButton.setText(PreferencesMessages.MadlBasePreferencePage_font_scale_indicator);
        ...
        largeFontsButton.setText(PreferencesMessages.MadlBasePreferencePage_font_scale_indicator);
        ...
        xlFontsButton.setText(PreferencesMessages.MadlBasePreferencePage_font_scale_indicator);
      ...
      selectFontButton.setText(PreferencesMessages.MadlBasePreferencePage_code_font_select_label);
      ...
      resetButton.setText(PreferencesMessages.MadlBasePreferencePage_reset_button_label);
    ...
    private void createPreviewer(Composite parent) {
      ...
      previewViewer = new SourceViewer(previewComp, null, SWT.BORDER /*
                                                                      * | SWT.V_SCROLL |
                                                                      * SWT.H_SCROLL
                                                                      */);
    ...
    private IDocument getDocument() {
      ...
      new MadlDocumentSetupParticipant().setup(document);
      return document;
    }
    ...
    private SourceViewerConfiguration getSourceViewerConfiguration() {
      return new MadlSourceViewerConfiguration(new MadlColorManager(), new PreferenceStore(), null,
    ...
    private void performOk() {
      ...
      if (key == VIEW_FONT_KEY) {
        persistFont("org.eclipse.debug.ui.VariableTextFont" /*
                                                             * IDebugUIConstants.PREF_VARIABLE_TEXT_FONT
                                                             */, baseData);
        persistFont(
      ...
      /*
       * The following block of code adjusts fonts in dialogs. There are some issues, like much of
       * the non-framework section of the page not getting changed. For now, it is commented out.
       */
...
//      scaleFontNamed(JFaceResources.DEFAULT_FONT, height);
    ...
    private void updateFont(Font font) {
      ...
      int newCodeFontSize = findScaledCodeFontSize(oldCodeFontSize, oldBaseFontSize,
          newBaseFontSize);
      baseData = data;
  ...
  public static final String FONT_PREF_PAGE_ID = "edu.depaul.cdm.madl.tools.ui.preferences.FontPreferencePage"; //$NON-NLS-1$
  public static final String EDITOR_FONT_KEY = PreferenceConstants.EDITOR_TEXT_FONT;
  public static final String EDITOR_DEFAULT_FONT_KEY = "edu.depaul.cdm.madl.tools.ui.editors.textfont.default";
  public static final String EDITOR_BASE_FONT_KEY = "edu.depaul.cdm.madl.tools.ui.editors.basefont";

  public static final String BASE_DEFAULT_FONT_KEY = "edu.depaul.cdm.madl.tools.ui.editors.basefont.default";
  public static final String VIEW_FONT_KEY = PreferenceConstants.VIEW_TEXT_FONT;

  public static final String VIEW_BASE_FONT_KEY = "edu.depaul.cdm.madl.tools.ui.views.basefont";
...
// Available font sizes
  ...
  public FontPreferencePage() {
    setPreferenceStore(MadlToolsPlugin.getDefault().getPreferenceStore());
    //   setDescription(PreferencesMessages.MadlBasePreferencePage_text_font);
  ...
  protected Control createContents(Composite parent) {
    ...
    editorComposite = new FontSelectionComposite(composite, SWT.NONE, EDITOR_BASE_FONT_KEY,
        EDITOR_FONT_KEY, "Editors");
    viewComposite = new FontSelectionComposite(composite, SWT.NONE, VIEW_BASE_FONT_KEY,
        VIEW_FONT_KEY, "Views");
