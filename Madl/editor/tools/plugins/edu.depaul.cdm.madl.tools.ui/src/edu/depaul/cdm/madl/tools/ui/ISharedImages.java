...
public interface ISharedImages {
   ...
   */
  public static final String IMG_OBJS_CUNIT = MadlPluginImages.IMG_OBJS_CUNIT;

  /**
   * Key to access the shared image or image descriptor for a JavaScript class file.
   */
  public static final String IMG_OBJS_CFILE = MadlPluginImages.IMG_OBJS_CFILE;

  /**
   * Key to access the shared image or image descriptor for a JAR archive.
   */
  public static final String IMG_OBJS_JAR = MadlPluginImages.IMG_OBJS_JAR;

  /**
   * Key to access the shared image or image descriptor for a JAR with source.
   */
  public static final String IMG_OBJS_JAR_WITH_SOURCE = MadlPluginImages.IMG_OBJS_JAR_WSRC;

  /**
   * Key to access the shared image or image descriptor for external archives.
   */
  public static final String IMG_OBJS_EXTERNAL_ARCHIVE = MadlPluginImages.IMG_OBJS_EXTJAR;

  /**
   * Key to access the shared image or image descriptor for external archives with source.
   */
  public static final String IMG_OBJS_EXTERNAL_ARCHIVE_WITH_SOURCE = MadlPluginImages.IMG_OBJS_EXTJAR_WSRC;

  /**
   * Key to access the shared image or image descriptor for a classpath variable entry.
   */
  public static final String IMG_OBJS_CLASSPATH_VAR_ENTRY = MadlPluginImages.IMG_OBJS_ENV_VAR;

  /**
   * Key to access the shared image or image descriptor for a library (class path container).
   */
  public static final String IMG_OBJS_LIBRARY = MadlPluginImages.IMG_OBJS_LIBRARY;

  /**
   * Key to access the shared image or image descriptor for a package fragment root.
   */
  public static final String IMG_OBJS_PACKFRAG_ROOT = MadlPluginImages.IMG_OBJS_PACKFRAG_ROOT;

  /**
   * Key to access the shared image or image descriptor for a package.
   */
  public static final String IMG_OBJS_PACKAGE = MadlPluginImages.IMG_OBJS_PACKAGE;

  /**
   * Key to access the shared image or image descriptor for an empty package.
   */
  public static final String IMG_OBJS_EMPTY_PACKAGE = MadlPluginImages.IMG_OBJS_EMPTY_PACKAGE;

  /**
   * Key to access the shared image or image descriptor for a logical package.
   */
  public static final String IMG_OBJS_LOGICAL_PACKAGE = MadlPluginImages.IMG_OBJS_LOGICAL_PACKAGE;

  /**
   * Key to access the shared image or image descriptor for an empty logical package.
   */
  public static final String IMG_OBJS_EMPTY_LOGICAL_PACKAGE = MadlPluginImages.IMG_OBJS_EMPTY_LOGICAL_PACKAGE;

  /**
   * Key to access the shared image or image descriptor for a class.
   */
  public static final String IMG_OBJS_CLASS = MadlPluginImages.IMG_OBJS_CLASS;

  /**
   * Key to access the shared image or image descriptor for a class with default visibility.
   */
  public static final String IMG_OBJS_CLASS_DEFAULT = MadlPluginImages.IMG_OBJS_CLASS_DEFAULT;

  /**
   * Key to access the shared image or image descriptor for a public inner class.
   */
  public static final String IMG_OBJS_INNER_CLASS_PUBLIC = MadlPluginImages.IMG_OBJS_INNER_CLASS_PUBLIC;

  /**
   * Key to access the shared image or image descriptor for a inner class with default visibility.
   */
  public static final String IMG_OBJS_INNER_CLASS_DEFAULT = MadlPluginImages.IMG_OBJS_INNER_CLASS_DEFAULT;

  /**
   * Key to access the shared image or image descriptor for a protected inner class.
   */
  public static final String IMG_OBJS_INNER_CLASS_PROTECTED = MadlPluginImages.IMG_OBJS_INNER_CLASS_PROTECTED;

  /**
   * Key to access the shared image or image descriptor for a private inner class.
   */
  public static final String IMG_OBJS_INNER_CLASS_PRIVATE = MadlPluginImages.IMG_OBJS_INNER_CLASS_PRIVATE;

  /**
   * Key to access the shared image or image descriptor for an interface.
   */
  public static final String IMG_OBJS_INTERFACE = MadlPluginImages.IMG_OBJS_INTERFACE;

  /**
   * Key to access the shared image or image descriptor for an interface with default visibility.
   */
  public static final String IMG_OBJS_INTERFACE_DEFAULT = MadlPluginImages.IMG_OBJS_INTERFACE_DEFAULT;

  /**
   * Key to access the shared image or image descriptor for a public inner interface.
   */
  public static final String IMG_OBJS_INNER_INTERFACE_PUBLIC = MadlPluginImages.IMG_OBJS_INNER_INTERFACE_PUBLIC;

  /**
   * Key to access the shared image or image descriptor for an inner interface with default
   * visibility.
   */
  public static final String IMG_OBJS_INNER_INTERFACE_DEFAULT = MadlPluginImages.IMG_OBJS_INNER_INTERFACE_DEFAULT;

  /**
   * Key to access the shared image or image descriptor for a protected inner interface.
   */
  public static final String IMG_OBJS_INNER_INTERFACE_PROTECTED = MadlPluginImages.IMG_OBJS_INNER_INTERFACE_PROTECTED;

  /**
   * Key to access the shared image or image descriptor for a private inner interface.
   */
  public static final String IMG_OBJS_INNER_INTERFACE_PRIVATE = MadlPluginImages.IMG_OBJS_INNER_INTERFACE_PRIVATE;

  /**
   * Key to access the shared image or image descriptor for a package declaration.
   */
  public static final String IMG_OBJS_PACKDECL = MadlPluginImages.IMG_OBJS_PACKDECL;

  /**
   * Key to access the shared image or image descriptor for an import container.
   */
  public static final String IMG_OBJS_IMPCONT = MadlPluginImages.IMG_OBJS_IMPCONT;

  /**
   * Key to access the shared image or image descriptor for an import statement.
   */
  public static final String IMG_OBJS_IMPDECL = MadlPluginImages.IMG_OBJS_IMPDECL;

  /** Key to access the shared image or image descriptor for a public member. */
  public static final String IMG_OBJS_PUBLIC = MadlPluginImages.IMG_MISC_PUBLIC;

  /** Key to access the shared image or image descriptor for a protected member. */
  public static final String IMG_OBJS_PROTECTED = MadlPluginImages.IMG_MISC_PROTECTED;

  /** Key to access the shared image or image descriptor for a private member. */
  public static final String IMG_OBJS_PRIVATE = MadlPluginImages.IMG_MISC_PRIVATE;

  /**
   * Key to access the shared image or image descriptor for class members with default visibility.
   */
  public static final String IMG_OBJS_DEFAULT = MadlPluginImages.IMG_MISC_DEFAULT;

  /**
   * Key to access the shared image or image descriptor for a public field.
   */
  public static final String IMG_FIELD_PUBLIC = MadlPluginImages.IMG_FIELD_PUBLIC;

  /**
   * Key to access the shared image or image descriptor for a protected field.
   */
  public static final String IMG_FIELD_PROTECTED = MadlPluginImages.IMG_FIELD_PROTECTED;

  /**
   * Key to access the shared image or image descriptor for a private field.
   */
  public static final String IMG_FIELD_PRIVATE = MadlPluginImages.IMG_FIELD_PRIVATE;

  /**
   * Key to access the shared image or image descriptor for a field with default visibility.
   */
  public static final String IMG_FIELD_DEFAULT = MadlPluginImages.IMG_FIELD_DEFAULT;

  /**
   * Key to access the shared image or image descriptor for a local variable.
   */
  public static final String IMG_OBJS_LOCAL_VARIABLE = MadlPluginImages.IMG_OBJS_LOCAL_VARIABLE;

  /**
   * Key to access the shared image or image descriptor for a enum type.
   */
  public static final String IMG_OBJS_ENUM = MadlPluginImages.IMG_OBJS_ENUM;

  /**
   * Key to access the shared image or image descriptor for a enum type with default visibility.
   */
  public static final String IMG_OBJS_ENUM_DEFAULT = MadlPluginImages.IMG_OBJS_ENUM_DEFAULT;

  /**
   * Key to access the shared image or image descriptor for a enum type with protected visibility.
   */
  public static final String IMG_OBJS_ENUM_PROTECTED = MadlPluginImages.IMG_OBJS_ENUM_PROTECTED;

  /**
   * Key to access the shared image or image descriptor for a enum type with private visibility.
   */
  public static final String IMG_OBJS_ENUM_PRIVATE = MadlPluginImages.IMG_OBJS_ENUM_PRIVATE;

  /**
   * Key to access the shared image or image descriptor for a annotation type.
   */
  public static final String IMG_OBJS_ANNOTATION = MadlPluginImages.IMG_OBJS_ANNOTATION;

  /**
   * Key to access the shared image or image descriptor for a annotation type with default
   * visibility.
   */
  public static final String IMG_OBJS_ANNOTATION_DEFAULT = MadlPluginImages.IMG_OBJS_ANNOTATION_DEFAULT;

  /**
   * Key to access the shared image or image descriptor for a annotation type with protected
   * visibility.
   */
  public static final String IMG_OBJS_ANNOTATION_PROTECTED = MadlPluginImages.IMG_OBJS_ANNOTATION_PROTECTED;

  /**
   * Key to access the shared image or image descriptor for a annotation type with private
   * visibility.
   */
  public static final String IMG_OBJS_ANNOTATION_PRIVATE = MadlPluginImages.IMG_OBJS_ANNOTATION_PRIVATE;

  /**
   * Key to access the shared image or image descriptor for javadoc tags.
   */
  public static final String IMG_OBJS_JAVADOCTAG = MadlPluginImages.IMG_OBJS_JAVADOCTAG;
