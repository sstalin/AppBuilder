...
import edu.depaul.cdm.madl.tools.ui.text.IColorManagerExtension;
...
public class SemanticHighlightingManager implements IPropertyChangeListener {
  ...
  /** The source viewer */
  private MadlSourceViewer fSourceViewer;
  /** The color manager */
  private IColorManager fColorManager;
  /** The preference store */
  private IPreferenceStore fPreferenceStore;
  /** The source viewer configuration */
  private MadlSourceViewerConfiguration fConfiguration;
  /** The presentation reconciler */
  private MadlPresentationReconciler fPresentationReconciler;
   ...
   */
  public void install(MadlEditor editor, MadlSourceViewer sourceViewer, IColorManager colorManager,
    ...
    if (fEditor != null) {
      fConfiguration = editor.createMadlSourceViewerConfiguration();
      fPresentationReconciler = (MadlPresentationReconciler) fConfiguration.getPresentationReconciler(sourceViewer);
    } else {
      fConfiguration = null;
   ...
   */
  public void install(MadlSourceViewer sourceViewer, IColorManager colorManager,
