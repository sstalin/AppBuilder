...
//import edu.depaul.cdm.madl.editor.ui.text.editor.tmp.JavaScriptCore;

import edu.depaul.cdm.madl.tools.ui.internal.text.functions.CombinedWordRule.CharacterBuffer;
...
public class MadlCommentScanner extends AbstractMadlScanner {
  ...
  protected static final String TASK_TAG = IMadlColorConstants.TASK_TAG;
  /**
 ...
 // private static final String ENABLED = JavaScriptCore.ENABLED;
  ...
  public MadlCommentScanner(IColorManager manager, IPreferenceStore store, Preferences coreStore,
   ...
   */
  public MadlCommentScanner(IColorManager manager, IPreferenceStore store,
      String defaultTokenProperty) {
