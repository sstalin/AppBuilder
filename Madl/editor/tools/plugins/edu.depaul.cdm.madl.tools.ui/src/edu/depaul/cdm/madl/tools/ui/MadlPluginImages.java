...
public class MadlPluginImages {
  ...
  private static final String NAME_PREFIX = "com.google.madl.tools.ui."; //$NON-NLS-1$
  ...
  private static final String T_MADL = "madl16"; //$NON-NLS-1$
   ...
   */
  public static final ImageDescriptor DESC_MADL_LIB_FILE = createUnManaged(
      T_MADL,
      "package_obj.gif"); //$NON-NLS-1$
  public static final ImageDescriptor DESC_MADL_COMP_UNIT = createUnManaged(T_MADL, "madl.png"); //$NON-NLS-1$
  public static final ImageDescriptor DESC_MADL_HTML_FILE = createUnManaged(T_MADL, "html.png"); //$NON-NLS-1$
  public static final ImageDescriptor DESC_MADL_CLASS_TYPE_ALIAS = createUnManaged(
      T_MADL,
      "typevariable_obj.gif"); //$NON-NLS-1$

  public static final ImageDescriptor DESC_MADL_FUNCTIONTYPE_PUBLIC = createUnManaged(
      T_MADL,
      "functiontype_public.png"); //$NON-NLS-1$
  public static final ImageDescriptor DESC_MADL_FUNCTIONTYPE_PRIVATE = createUnManaged(
      T_MADL,
      "functiontype_private.png"); //$NON-NLS-1$

  public static final ImageDescriptor DESC_MADL_CLASS_PUBLIC = createUnManaged(
      T_MADL,
      "class_public.png"); //$NON-NLS-1$
  public static final ImageDescriptor DESC_MADL_CLASS_PRIVATE = createUnManaged(
      T_MADL,
      "class_private.png"); //$NON-NLS-1$
  public static final ImageDescriptor DESC_MADL_INTERFACE = createUnManaged(
      T_MADL,
      "interface_public.png"); //$NON-NLS-1$
  public static final ImageDescriptor DESC_MADL_INNER_INTERFACE_PRIVATE = createUnManaged(
      T_MADL,
      "interface_private.png"); //$NON-NLS-1$

  public static final ImageDescriptor DESC_MADL_METHOD_PUBLIC = createUnManaged(
      T_MADL,
      "method_public.png"); //$NON-NLS-1$
  public static final ImageDescriptor DESC_MADL_FIELD_PUBLIC = createUnManaged(
      T_MADL,
      "field_public.png"); //$NON-NLS-1$

  public static final ImageDescriptor DESC_MADL_METHOD_PRIVATE = createUnManaged(
      T_MADL,
      "method_private.png"); //$NON-NLS-1$
  public static final ImageDescriptor DESC_MADL_FIELD_PRIVATE = createUnManaged(
      T_MADL,
  ...
  /*
   * Helper method to access the image registry from the MadlToolsPlugin class.
   */
  ...
  private static ImageDescriptor create(String prefix, String name,
    ...
    return createImageDescriptor(
        MadlToolsPlugin.getDefault().getBundle(),
        path,
  ...
  private static ImageDescriptor createManaged(String prefix, String name, String key) {
    ...
    if (fgImageRegistry != null) {
      MadlToolsPlugin.logErrorMessage("Image registry already defined"); //$NON-NLS-1$
    }
    return result;
  }
