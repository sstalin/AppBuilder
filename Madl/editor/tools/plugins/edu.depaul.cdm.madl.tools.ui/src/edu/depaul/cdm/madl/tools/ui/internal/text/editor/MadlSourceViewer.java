...
public class MadlSourceViewer extends ProjectionViewer implements IPropertyChangeListener {
  ...
  public MadlSourceViewer(Composite parent, IVerticalRuler verticalRuler,
   ...
   * color is <em>only</em> set if it's visibly distinct from the default Madl source text color.
   * 
  ...
  public void adaptBackgroundColor(Control control) {
    ...
    Color javaDefaultColor = MadlUI.getColorManager().getColor(IMadlColorConstants.JAVA_DEFAULT);
  ...
  public void configure(SourceViewerConfiguration configuration) {
    ...
    if (configuration instanceof MadlSourceViewerConfiguration) {
      MadlSourceViewerConfiguration javaSVCconfiguration = (MadlSourceViewerConfiguration) configuration;
  ...
  public IFormattingContext createFormattingContext() {
    ...
    Map map = new HashMap(MadlCore.getOptions());
