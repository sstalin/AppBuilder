 ...
 */
final class MadlEditorMessages extends NLS {
  ...
  private static final String BUNDLE_NAME = MadlEditorMessages.class.getName();
  ...
  static {
    NLS.initializeMessages(BUNDLE_NAME, MadlEditorMessages.class);
  }
