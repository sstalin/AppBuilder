...
public final class MadlUIMessages extends NLS {

  private static final String BUNDLE_NAME = "edu.depaul.cdm.madl.tools.ui.MadlUIMessages";//$NON-NLS-1$
  ...
  static {
    NLS.initializeMessages(BUNDLE_NAME, MadlUIMessages.class);
  }
