...
//   */
//  public boolean consumesExportClause(SemanticToken<MadlDirective> token) {
//    return false;
//  }
//
//  /**
...
//   * @see SemanticHighlighting#consumesIdentifier(SemanticToken)
//   */
//  public boolean consumesHideClause(SemanticToken<MadlDirective> token) {
//    return false;
//  }
...
//   * @see SemanticHighlighting#consumesIdentifier(SemanticToken)
//   */
//  public boolean consumesImportDirective(SemanticToken<MadlDirective> token) {
//    return false;
//  }
//
//  /**
...
//   * @see SemanticHighlighting#consumesIdentifier(SemanticToken)
//   */
//  public boolean consumesLibraryDirective(SemanticToken<MadlDirective> directiveToken) {
//    return false;
//  }
...
//   */
//  public boolean consumesLiteral(SemanticToken<MadlLiteral> token) {
//    return false;
//  }
...
//   * @see SemanticHighlighting#consumesIdentifier(SemanticToken)
//   */
//  public boolean consumesOfClause(SemanticToken<MadlDirective> token) {
//    return false;
//  }
//
//  /**
...
//   * @see SemanticHighlighting#consumesIdentifier(SemanticToken)
//   */
//  public boolean consumesPartDirective(SemanticToken<MadlDirective> token) {
//    return false;
//  }
//
//  /**
...
//   * @see SemanticHighlighting#consumesIdentifier(SemanticToken)
//   */
//  public boolean consumesPartOfDirective(SemanticToken<MadlDirective> token) {
//    return false;
//  }
//
//  /**
...
//   */
//
//  public boolean consumesShowClause(SemanticToken<MadlDirective> token) {
//    return false;
//  }
  ...
  private String getThemeColorKey() {
    return MadlUI.ID_PLUGIN + "." + getPreferenceKey() + "Highlighting"; //$NON-NLS-1$//$NON-NLS-2$
  }
