 ...
 */
public final class MadlPairMatcher extends DefaultCharacterPairMatcher implements
  ...
  public MadlPairMatcher(char[] pairs) {
    super(pairs, MadlPartitions.MADL_PARTITIONING);
  }
  ...
  /*
   * @see edu.depaul.cdm.madl.tools.ui.functions.ISourceVersionDependent#setSourceVersion
   * (java.lang.String)
   */
  @Override
 ...
 /*   if (JavaScriptCore.VERSION_1_5.compareTo(version) <= 0) {
  ...
  private boolean isLessThanOperator(IDocument document, int offset) throws BadLocationException {
   ...
   return false;
/*    MadlHeuristicScanner scanner = new MadlHeuristicScanner(
        document,
        MadlPartitions.MADL_PARTITIONING,
        TextUtilities.getContentType(document, MadlPartitions.MADL_PARTITIONING, offset, false));
