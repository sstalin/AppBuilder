...
public class SWTUtil {
  ...
  public static void eraseSelection(Event event, Scrollable control, IPreferenceStore prefs) {
    ...
    Color fgColor = MadlUI.getViewerSelectionForeground(prefs, control.getDisplay());
    if (fgColor != null) {
      gc.setForeground(fgColor);
    }
    Color bgColor = MadlUI.getViewerSelectionBackground(prefs, control.getDisplay());
    if (bgColor != null) {
...
//    ctl.setForeground(MadlUI.getColorManager().getColor(rgb));
//    rgb = PreferenceConverter.getColor(store, AbstractTextEditor.PREFERENCE_COLOR_BACKGROUND);
//    ctl.setBackground(MadlUI.getColorManager().getColor(rgb));
  }
  ...
  private static Color createColor(IPreferenceStore store, String key) {
    ...
    if (store.contains(key)) {
      ...
      if (rgb != null) {
        return MadlUI.getColorManager().getColor(rgb);
      }
    }
    return null;
  }
