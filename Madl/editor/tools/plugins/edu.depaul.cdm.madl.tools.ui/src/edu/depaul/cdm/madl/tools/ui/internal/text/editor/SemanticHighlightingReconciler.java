...
import edu.depaul.cdm.madl.engine.ast.visitor.GeneralizingASTVisitor;
...
import edu.depaul.cdm.madl.tools.ui.internal.text.editor.SemanticHighlightingManager.HighlightedPosition;
import edu.depaul.cdm.madl.tools.ui.internal.text.editor.SemanticHighlightingManager.Highlighting;
 ...
 */
public class SemanticHighlightingReconciler implements IMadlReconcilingListener, ITextInputListener {
  ...
  /** The Madl editor on which this semantic highlighting reconciler is installed */
  private MadlEditor fEditor;
   ...
   * {@link #reconciled(MadlUnit, boolean, IProgressMonitor)}
   */
   ...
   */
  public void install(MadlEditor editor, MadlSourceViewer sourceViewer,
...
//    final MadlElement element = fEditor.getInputMadlElement();
    ...
    synchronized (fJobLock) {
      ...
      fJob = new Job(MadlEditorMessages.SemanticHighlighting_job) {
        @Override
