...
import edu.depaul.cdm.madl.tools.ui.internal.preferences.FontPreferencePage;
...
public class MadlConsoleView extends ViewPart implements IConsoleView, IPropertyChangeListener {
  ...
  public static final String VIEW_ID = "edu.depaul.cdm.madl.tools.ui.console";
  ...
  public MadlConsoleView() {
    MadlConsoleManager.getManager().consoleViewOpened(this);
  }
  ...
  public void dispose() {
    ...
    MadlConsoleManager.getManager().consoleViewClosed(this);
