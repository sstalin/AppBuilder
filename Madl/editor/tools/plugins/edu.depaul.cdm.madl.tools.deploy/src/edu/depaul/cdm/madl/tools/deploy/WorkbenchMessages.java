...
public class WorkbenchMessages extends NLS {
  ...
  public static String MadlIDEApplication_already_running_dialog_cancel_button;
  public static String MadlIDEApplication_already_running_dialog_msg;
  public static String MadlIDEApplication_already_running_dialog_run_button;
  public static String MadlIDEApplication_already_running_dialog_title;
