...
import edu.depaul.cdm.madl.engine.error.AnalysisErrorListener;
import edu.depaul.cdm.madl.engine.source.Source;
import edu.depaul.cdm.madl.engine.utilities.collection.IntList;
...
/**
 * The class {@code Scanner} implements a scanner for Madl code.
 * <p>
 * The lexical structure of Madl is ambiguous without knowledge of the context in which a token is
