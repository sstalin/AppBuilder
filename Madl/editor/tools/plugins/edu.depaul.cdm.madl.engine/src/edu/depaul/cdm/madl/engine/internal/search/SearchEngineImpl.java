 ...
 * the License.
 */
package edu.depaul.cdm.madl.engine.internal.search;
...
import edu.depaul.cdm.madl.engine.index.Location;
import edu.depaul.cdm.madl.engine.index.LocationWithData;
import edu.depaul.cdm.madl.engine.index.Relationship;
import edu.depaul.cdm.madl.engine.index.RelationshipCallback;
import edu.depaul.cdm.madl.engine.internal.element.member.Member;
import edu.depaul.cdm.madl.engine.internal.index.IndexConstants;
import edu.depaul.cdm.madl.engine.internal.index.NameElementImpl;

import edu.depaul.cdm.madl.engine.internal.search.listener.CountingSearchListener;
import edu.depaul.cdm.madl.engine.internal.search.listener.FilteredSearchListener;
import edu.depaul.cdm.madl.engine.internal.search.listener.GatheringSearchListener;
import edu.depaul.cdm.madl.engine.internal.search.listener.NameMatchingSearchListener;

import edu.depaul.cdm.madl.engine.internal.search.scope.LibrarySearchScope;
import edu.depaul.cdm.madl.engine.search.MatchKind;
import edu.depaul.cdm.madl.engine.search.MatchQuality;
import edu.depaul.cdm.madl.engine.search.SearchEngine;
import edu.depaul.cdm.madl.engine.search.SearchFilter;
