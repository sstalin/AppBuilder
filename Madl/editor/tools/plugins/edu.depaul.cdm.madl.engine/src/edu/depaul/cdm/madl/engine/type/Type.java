 ...
 * the License.
 */
package edu.depaul.cdm.madl.engine.type;
...
public interface Type {
  ...
  /**
   * Return {@code true} if this type represents the type 'Function' defined in the madl:core
   * library.
   * 
   * @return {@code true} if this type represents the type 'Function' defined in the madl:core
   *         library
   */
  public boolean isMadlCoreFunction();
