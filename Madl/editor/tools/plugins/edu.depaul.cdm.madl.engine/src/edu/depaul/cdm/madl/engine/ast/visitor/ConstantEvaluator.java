...
import edu.depaul.cdm.madl.engine.ast.AdjacentStrings;
...
import edu.depaul.cdm.madl.engine.ast.InterpolationElement;
import edu.depaul.cdm.madl.engine.ast.InterpolationExpression;
import edu.depaul.cdm.madl.engine.ast.InterpolationString;
import edu.depaul.cdm.madl.engine.ast.ListLiteral;
import edu.depaul.cdm.madl.engine.ast.MapLiteral;
import edu.depaul.cdm.madl.engine.ast.MapLiteralEntry;
import edu.depaul.cdm.madl.engine.ast.MethodInvocation;
import edu.depaul.cdm.madl.engine.ast.NullLiteral;
import edu.depaul.cdm.madl.engine.ast.ParenthesizedExpression;
import edu.depaul.cdm.madl.engine.ast.PrefixExpression;
import edu.depaul.cdm.madl.engine.ast.PrefixedIdentifier;
import edu.depaul.cdm.madl.engine.ast.PropertyAccess;
import edu.depaul.cdm.madl.engine.ast.SimpleIdentifier;
import edu.depaul.cdm.madl.engine.ast.SimpleStringLiteral;
import edu.depaul.cdm.madl.engine.ast.StringInterpolation;
import edu.depaul.cdm.madl.engine.ast.StringLiteral;
import edu.depaul.cdm.madl.engine.ast.SymbolLiteral;
import edu.depaul.cdm.madl.engine.element.Element;
import edu.depaul.cdm.madl.engine.element.FieldElement;
