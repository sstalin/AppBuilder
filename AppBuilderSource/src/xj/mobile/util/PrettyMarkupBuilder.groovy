 ...
 * @author Paul King
 */
public class PrettyMarkupBuilder extends BuilderSupport {
   ...
   */
  public PrettyMarkupBuilder(PrintWriter pw) {
   ...
   * @see IndentPrinter#IndentPrinter(Writer)
   */
  public PrettyMarkupBuilder(Writer writer) {
   ...
   */
  public PrettyMarkupBuilder(IndentPrinter out) {
	this.out = out;
  }
  ...
  protected Object createNode(Object name, Map attributes, Object value) {
	...
	toState(1, theName);
	boolean first = true
	String pad = ' ' * (theName.toString().length() + 2)
  ...
  private Object getQName(Object name) {
